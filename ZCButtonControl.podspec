...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xiaowu2016/ZCButtonControl"
  ...
  s.source       = { :git => "https://github.com/xiaowu2016/ZCButtonControl.git", :tag => "0.1.3" }
  ...
  s.source_files  = "Classes", "ZCButtonControl/ZCControl/**/*.{h,m}"
